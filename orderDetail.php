...
<div class="content clearfix">
	...
	<div class="rightContent">
		...
		<table width="100%" class="table table-noborder">
			<tbody>
				<tr>
					<th width="17%" height="30">Order number</th>
					<td width="83%">1004</td>
				</tr>
				<tr>
					<th width="17%" height="30">Date</th>
					<td width="83%">2011-11-17 00:13:13 GMT</td>
				</tr>

				<tr>
					<th width="17%" height="30">Status</th>
					<td width="83%">Open</td>
				</tr>
				...
				<tr>
					...
					<td width="83%">Herr Juan Testing<br>
						...
						Bremen, 09876 <br>
						Baden-Württemberg, Deutschland<br>	</td>
					</tr>
					<tr>
